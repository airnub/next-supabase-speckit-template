...
- If a user **tags the app** or replies using a recognisable pattern (e.g., `@APP AAPL = 190.00`, or `ABOVE/BELOW/EQUAL`), the inbound webhook **parses** symbol, mode, and guess and inserts a **pending** or **accepted** guess.
